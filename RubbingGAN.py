...
parser.add_argument('--dataroot', required=False,
  default='C:/Users/Tommy/Desktop/project/RubbingGAN-main/data/maps/train/', help='path to trn dataset')
parser.add_argument('--valDataroot', required=False,
  default='C:/Users/Tommy/Desktop/project/RubbingGAN-main/data/maps/val/', help='path to val dataset')
...
parser.add_argument('--exp', default='D:/Data1/test_checkpoint1', help='folder to output images and model checkpoints')
parser.add_argument('--display', type=int, default=200, help='interval for displaying train-logs')
...
writer1 = SummaryWriter('C:/Users/Tommy/Desktop/project/RubbingGAN/exp')
# get dataloader
...
for epoch in range(opt.niter):
  ...
  for i, data in enumerate(dataloader, 0):
    if opt.mode == 'B2A':
      ...
      # input_cpu.shape = torch.Size([1, 3, 256, 256])
    ...
    #print(torch.cat([fake,input],1).size())
    ...
    #vutils.save_image(x_hat,'/home1/sgb/began/x_hat/'+str(i)+'.png',normalize=True)
    fake1 = x_hat1.detach()
    fake1 = Variable(imagePool.query(fake1.data)) # sample from image buffer
  ...
  # do checkpointing
      torch.save(netG.state_dict(), '%s/netG_epoch_%08d_iter%08d.pth' % (opt.exp, epoch, ganIterations))
      #torch.save(netD.state_dict(), '%s/netD_epoch_%08d_iter%08d.pth' % (opt.exp, epoch, ganIterations))
